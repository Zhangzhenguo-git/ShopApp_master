...
import com.dc.shopapp.weight.IMGRigTopPointView;
import com.dc.shopapp.weight.IMGUsedRigTopPointView;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageHolder> {
    ...
    public MessageHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View contentView= LayoutInflater.from(mContext).inflate(R.layout.shop_message_listitem,parent,false);
