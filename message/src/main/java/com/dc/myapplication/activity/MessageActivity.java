...
import com.dc.myapplication.adapter.MessageAdapter;
...
import com.dc.myapplication.presenter.MessagePresenter;
import com.dc.myapplication.weight.CustomMessageDetailsDialog;
...
public class MessageActivity extends BaseActivity implements MessageContract.View {
    ...
    public void initView() {
        ...
        msgHeadView.setHeadShowOrHide(View.VISIBLE, View.VISIBLE, View.GONE, View.VISIBLE);
        msgHeadView.setHeadContent(R.drawable.msg_return_icon, "消息", R.drawable.msg_search_icon, "编辑");
